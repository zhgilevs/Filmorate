DELETE
FROM FRIENDS; -- ON for tests, OFF for prod
DELETE
FROM LIKES; -- ON for tests, OFF for prod
DELETE
FROM FILM_GENRES; -- ON for tests, OFF for prod
DELETE
FROM FILMS; -- ON for tests, OFF for prod
DELETE
FROM GENRES;
DELETE
FROM MPAS;
DELETE
FROM USERS; -- ON for tests, OFF for prod
ALTER TABLE FILMS
